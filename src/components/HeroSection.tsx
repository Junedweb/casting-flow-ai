...
export const HeroSection = () => {
  ...
  return (
    <>
      ...
      <section className="min-h-screen flex items-center justify-center px-3 py-4 bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900">
        ...
        <div className="relative w-full max-w-xs mx-auto text-center">
          {/* Who We Are */}
          <div className="mb-4">
            <div className="inline-flex items-center justify-center w-12 h-12 mx-auto mb-2 bg-gradient-to-br from-orange-500 to-red-600 rounded-full shadow-lg">
          ...
          {/* The Hook */}
          <h1 className="text-lg font-bold text-white mb-3 leading-tight">
            Turn Your 3-Hour<br />
          ...
          {/* What We Do */}
          <div className="bg-slate-800/70 backdrop-blur-sm rounded-lg p-3 mb-4 border border-slate-700">
          ...
          <div className="bg-gradient-to-r from-orange-500/20 to-red-600/20 backdrop-blur-sm rounded-lg p-3 mb-4 border border-orange-500/30">
            <h3 className="text-orange-400 font-semibold text-xs mb-1">
          ...
          <div className="space-y-1.5">
            <div className="flex items-center text-left bg-slate-800/40 rounded-lg p-2.5 backdrop-blur-sm">
              <Database className="w-5 h-5 text-blue-400 mr-2.5 flex-shrink-0" aria-hidden="true" />
              <div>
            ...
            <div className="flex items-center text-left bg-slate-800/40 rounded-lg p-2.5 backdrop-blur-sm">
              <Users className="w-5 h-5 text-green-400 mr-2.5 flex-shrink-0" aria-hidden="true" />
              <div>
            ...
            <div className="flex items-center text-left bg-slate-800/40 rounded-lg p-2.5 backdrop-blur-sm">
              <Shield className="w-5 h-5 text-orange-400 mr-2.5 flex-shrink-0" aria-hidden="true" />
              <div>
