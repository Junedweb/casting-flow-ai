...
export const HeroSection = () => {
  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center px-4 py-8 bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900">
      ...
      <div className="relative max-w-5xl mx-auto text-center">
        <div className="mb-3">
          <div className="inline-flex items-center justify-center w-16 h-16 md:w-20 md:h-20 mx-auto mb-2 bg-gradient-to-br from-orange-500 to-red-600 rounded-full shadow-2xl">
        ...
        <div className="bg-slate-800/50 backdrop-blur-sm rounded-lg p-3 mb-4 max-w-2xl mx-auto border border-slate-700">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-3 max-w-3xl mx-auto">
          <div className="flex flex-col items-center text-center bg-slate-800/30 rounded-lg p-2.5 backdrop-blur-sm">
            <Database className="w-7 h-7 text-blue-400 mb-1.5" />
            <h3 className="text-white font-semibold mb-1 text-xs">Centralized Database</h3>
            <p className="text-slate-400 text-xs">All profiles in one secure place</p>
          </div>
          <div className="flex flex-col items-center text-center bg-slate-800/30 rounded-lg p-2.5 backdrop-blur-sm">
            <Users className="w-7 h-7 text-green-400 mb-1.5" />
            <h3 className="text-white font-semibold mb-1 text-xs">AI Face Matching</h3>
            <p className="text-slate-400 text-xs">Find perfect talent instantly</p>
          </div>
          <div className="flex flex-col items-center text-center bg-slate-800/30 rounded-lg p-2.5 backdrop-blur-sm">
            <Shield className="w-7 h-7 text-orange-400 mb-1.5" />
            <h3 className="text-white font-semibold mb-1 text-xs">GDPR Secure</h3>
