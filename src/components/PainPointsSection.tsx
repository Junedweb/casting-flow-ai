...
export const PainPointsSection = () => {
  ...
  const painPoints = [
    ...
    {
      text: "Maintaining a constant pool of trained actors is a challenge - they get outdated or leave the location when we get the chance to try them for casting.",
      impact: "40% of talent pool becomes unavailable",
      icon: MapPin
    }
  ];
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-4">
          <div className="inline-flex items-center gap-2 mb-1">
            ...
            <h2 className="text-xl md:text-2xl font-bold bg-gradient-to-r from-slate-900 via-red-600 to-blue-600 bg-clip-text text-transparent">
        ...
        <div className="grid lg:grid-cols-2 gap-4 mb-4">
          ...
          <div>
            <div className="flex items-center gap-2 mb-2">
              <div className="px-2 py-1 bg-red-500 rounded-lg shadow-sm">
                <AlertTriangle className="w-3 h-3 text-white inline mr-1" />
                <span className="text-white font-semibold text-xs">Casting Directors</span>
              </div>
              <span className="text-[10px] text-red-600">Real industry pain points</span>
            </div>
          ...
          <div>
            <div className="flex items-center gap-2 mb-2">
              <div className="px-2 py-1 bg-blue-500 rounded-lg shadow-sm">
                <Users className="w-3 h-3 text-white inline mr-1" />
                <span className="text-white font-semibold text-xs">Actors & Artists</span>
              </div>
              <span className="text-[10px] text-blue-600">Performer challenges</span>
            </div>
            ...
            <div className="flex items-start gap-2">
              ...
              <div className="flex-1">
                <div className="flex items-center gap-1 mb-1">
                  ...
                  <span className="ml-1 text-[10px] font-semibold text-emerald-700 bg-emerald-100 px-1 py-0.5 rounded-full">Success Story</span>
                </div>
                <blockquote className="text-xs text-slate-700 italic mb-1 leading-relaxed">
                ...
                <div className="flex items-center gap-1">
                  ...
                  <div>
                    ...
                    <p className="text-[8px] text-emerald-600">Small-Scale Casting Director, Mumbai</p>
                  </div>
                </div>
              </div>
            </div>
